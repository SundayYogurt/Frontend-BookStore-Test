  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const dataToSend = {
        ...
        category: comicData.category || undefined,
        publishYear: comicData.publishYear ? parseInt(comicData.publishYear) : undefined,
        isbn: comicData.isbn,
        series: comicData.series || undefined,
        volumeNumber: comicData.volumeNumber ? parseInt(comicData.volumeNumber) : undefined,
        illustrator: comicData.illustrator || undefined,
        colorType: comicData.colorType || undefined,
        targetAge: comicData.targetAge || undefined,
      ...
      const newComic = await ComicsService.createComic(dataToSend);
